...
int main(int argc, char **argv) {
	...
	for (int y = 0; y < in.height(); y++) {
        ...
        //int countx = state.getBitVec("add_351_352_353.in0").to_type<uint16_t>();
        //int county = state.getBitVec("add_354_352_355.in0").to_type<uint16_t>();
        //printf("in=%d, countx=%d, county=%d\n",in(x,y,c), countx, county);
