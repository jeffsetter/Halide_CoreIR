...
public:
    ...
    void compile_cpu() {
        ...
        output.tile(x, y, xo, yo, xi, yi, 6,6);
  ...
  void compile_coreir() {
    ...
    hw_output.compute_root();
    conv1.linebuffer();
    hw_output.tile(x, y, xo, yo, xi, yi, 10,10).reorder(xi,yi,xo,yo);
