...
int main(int argc, char **argv) {
  ...
  Image<uint32_t> out_native(in.width()-4, in.height()-4, in.channels());
  Image<uint32_t> out_hls(in.width()-4, in.height()-4, in.channels());
  Image<uint32_t> out_coreir(in.width()-4, in.height()-4, in.channels());
