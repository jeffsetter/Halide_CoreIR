#ifndef HALIDE_CODEGEN_RIGEL_BASE_H
#define HALIDE_CODEGEN_RIGEL_BASE_H

/** \file
 *
 * Defines an base class of the Rigel C code-generator
 */
#include "CodeGen_C.h"
#include "Module.h"
#include "Scope.h"
 ...
 */
class CodeGen_Rigel_Base : public CodeGen_C {
public:
    /** Initialize a C code generator pointing at a particular output
     * stream (e.g. a file, or std::cout) */
    CodeGen_Rigel_Base(std::ostream &dest, OutputKind output_kind = CPlusPlusImplementation,
